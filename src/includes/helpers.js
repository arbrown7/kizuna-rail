...
/**
 * Converts a number to a month name.
 * @param {number} monthIndex the number of the month.
 * @returns {string} The equivalent month of the year.
 */
...
export { generateConfirmationCode, kmToMiles, yenToUsd, getMonthNames };